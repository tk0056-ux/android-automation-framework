...
public class 卡密验证 {
    ...
    public static void 卡密验证结果处理(String 访问结果){
        ...
        // 卡密不存在！
        访问结果 =  "2026-12-16 23:25:24|||26084892|||空uictjaxoerprhjukhtmtsda|||1771082724|||7feaa47cba90abec1c0d55fead17561f";
        // 帐户已被封停，请联系管理处理！
        // 账号已到期
        // 2026-2-14 23:25:24|||会变|||会变|||会变|||会变
        // 成功返回三个文本数据，用|||分割，第一个到期时间或点数，第二个状态码Token，第三行远程数据，失败返回错误原因
